...
//         Note: when answering mention just the part then give its content mentioning the part title.
//     `],
//     ['human', '{input}']
// ])
...
const prompt = ChatPromptTemplate.fromMessages([
    ['system', `
        Act as an AI Career Assistant. Based on the user input generate a personalized motivational letter based on their resume and the job offer they are targeting. 
        The letter should be written in the specified language and tone, highlighting the candidate's relevant skills and experiences that match the job requirements. 
        Make it compelling and personalized to increase their chances of getting hired. 
        You must also give the enhanced resume based on the job offer and must be generated in the specified language. 
        And finally in a bullet points format cite all the enhancements you have made to get the enhanced resume.
    `],
    ['human', '{input}']
])
