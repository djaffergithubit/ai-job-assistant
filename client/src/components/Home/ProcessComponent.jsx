...
const ProcessPipeline = [
    {
        id:1,
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-upload w-8 h-8 text-white" data-lov-id="src/components/HowItWorksSection.tsx:60:20" data-lov-name="step.icon" data-component-path="src/components/HowItWorksSection.tsx" data-component-line="60" data-component-file="HowItWorksSection.tsx" data-component-name="step.icon" data-component-content="%7B%22className%22%3A%22w-8%20h-8%20text-white%22%7D"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" x2="12" y1="3" y2="15"></line></svg>,
    ...
    {
        id:2,
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-text w-8 h-8 text-white" data-lov-id="src/components/HowItWorksSection.tsx:60:20" data-lov-name="step.icon" data-component-path="src/components/HowItWorksSection.tsx" data-component-line="60" data-component-file="HowItWorksSection.tsx" data-component-name="step.icon" data-component-content="%7B%22className%22%3A%22w-8%20h-8%20text-white%22%7D"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path><path d="M14 2v4a2 2 0 0 0 2 2h4"></path><path d="M10 9H8"></path><path d="M16 13H8"></path><path d="M16 17H8"></path></svg>,
    ...
    {
        id:3,
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-download w-8 h-8 text-white" data-lov-id="src/components/HowItWorksSection.tsx:60:20" data-lov-name="step.icon" data-component-path="src/components/HowItWorksSection.tsx" data-component-line="60" data-component-file="HowItWorksSection.tsx" data-component-name="step.icon" data-component-content="%7B%22className%22%3A%22w-8%20h-8%20text-white%22%7D"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" x2="12" y1="15" y2="3"></line></svg>,
