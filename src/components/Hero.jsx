...
const Hero = () => {
  return (
    <main className=' mt-40 px-3.5 hero-bg'>
        <button className=' flex items-center bg-green-100 rounded-full border-2 border-solid border-green-200 pr-3.5 pl-1 cursor-pointer'>
        ...
        <section className=' pb-16'>
            <div className='grid grid-cols-12 mt-10 py-10 gap-x-3.5 gap-y-3.5 place-items-start'>
                    ...
                    <div className=' flex items-center gap-x-2.5 text-[#7588A3] text-sm font-normal'>
                        <span className=' flex items-center gap-1.5'>
                            <div className=' text-green-500'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock w-4 h-4 text-accent" data-lov-id="src/components/HeroSection.tsx:41:16" data-lov-name="Clock" data-component-path="src/components/HeroSection.tsx" data-component-line="41" data-component-file="HeroSection.tsx" data-component-name="Clock" data-component-content="%7B%22className%22%3A%22w-4%20h-4%20text-accent%22%7D"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                            </div>
                            95% de temps économisé
                        </span>
                        <span className=' flex items-center gap-1.5'>
                            <div className=' text-green-500'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-zap w-4 h-4 text-accent" data-lov-id="src/components/HeroSection.tsx:45:16" data-lov-name="Zap" data-component-path="src/components/HeroSection.tsx" data-component-line="45" data-component-file="HeroSection.tsx" data-component-name="Zap" data-component-content="%7B%22className%22%3A%22w-4%20h-4%20text-accent%22%7D"><path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"></path></svg>
                            </div>
                            +40% de réponses positives
                        </span>
                    </div>
                    <br />
                    <div className=' grid grid-cols-12 place-items-stretch gap-x-3.5 mb-8'>
                        <GetStartedBtn />
