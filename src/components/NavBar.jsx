    ...
    <header className=' fixed top-0 w-full z-20 bg-white'>
        <nav className=' flex items-center justify-between px-3.5 py-1.5 text-base border-b-[1.5px] border-solid border-gray-200 z-0'>
            ...
            <>
                ...
                <ul className=' lg:flex hidden items-center gap-3.5 py-2'>
                    <li className=' cursor-pointer text-shadow-gray-900 flex items-center font-medium hover:bg-green-500 hover:text-white px-3.5 py-1 rounded-xl'>
                    ...
                    <li className=' cursor-pointer bg-button px-3.5 py-1.5 rounded-xl hover:scale-105'>Commencer gratuitement</li>
                </ul>
            </>
